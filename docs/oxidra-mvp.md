...
2. 下一步注册 boundary-aware source projection，解除已验证 abandoned turn 的 cutoff barrier，再测量 3/5/10 次递归摘要漂移；只有数据支持时才默认启用自动 compaction。
